 ...
 * @LastEditTime: 2022-03-08 10:50:07
...
function App() {
    ...
    const touchStarted = (event: any) => {
        console.log('started')
        console.log(event.target.nodeName, !viewer?.isMouseNavEnabled(), 222)
